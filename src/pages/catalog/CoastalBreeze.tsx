      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-medium-grey max-w-3xl mx-auto">
            Ocean-inspired tranquility for your home. Natural textures, weathered finishes, 
            and breezy comfort bring the seaside indoors.
          </p>
        </div>
      </section>
            ...
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <div key={item} className="group cursor-pointer">
                <div className="aspect-square bg-light-grey rounded-2xl overflow-hidden mb-4 group-hover:scale-105 transition-transform duration-300">
                  <div className="w-full h-full bg-gradient-to-br from-soft-cream/80 to-light-grey/30" />
                </div>
                <h3 className="text-xl font-medium text-charcoal-black mb-2">
                  Coastal Bench {item}
                </h3>
                <p className="text-medium-grey mb-4">
                  Weathered beauty meets coastal comfort
                </p>
                <p className="text-2xl font-light text-warm-brown">
                  ${(549 + item * 70).toLocaleString()}
                </p>
              </div>
            ))}
          </div>
